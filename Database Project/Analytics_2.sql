...
USE SmartHome;
-- Per ogni utente vengono considerati i dispositivi più frequenti e il database suggerisce la fascia oraria giusta 
...
Prel:LOOP
    ...
    CREATE TABLE IF NOT EXISTS rend(		
